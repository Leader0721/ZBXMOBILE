package widget.swipebacklayout;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        int edgeSize = a.getDimensionPixelSize(R.styleable.SwipeBackLayout_swipeback_edge_size, -1);
        if (edgeSize > 0)
            setEdgeSize(edgeSize);
        int mode = EDGE_FLAGS[a.getInt(R.styleable.SwipeBackLayout_swipeback_edge_flag, 0)];
        setEdgeTrackingEnabled(mode);

        int shadowLeft = a.getResourceId(R.styleable.SwipeBackLayout_swipeback_shadow_left,
                R.mipmap.shadow_left);
        int shadowRight = a.getResourceId(R.styleable.SwipeBackLayout_swipeback_shadow_right,
                R.mipmap.shadow_right);
        int shadowBottom = a.getResourceId(R.styleable.SwipeBackLayout_swipeback_shadow_bottom,
     ...
     * callback's
     * {@link widget.swipebacklayout.lib.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link widget.swipebacklayout.lib.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}

package widget.pulltorefresh.header;

import widget.pulltorefresh.PtrFrameLayout;
import widget.pulltorefresh.PtrUIHandler;
import widget.pulltorefresh.PtrUIHandlerHook;
import widget.pulltorefresh.indicator.PtrIndicator;
...
public class MaterialHeader extends View implements PtrUIHandler {
    ...
    public MaterialProgressDrawable getDrawable(){
    	return mDrawable;
    }
}

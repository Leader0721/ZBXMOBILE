...
import com.zbar.lib.common.Runnable;
...
final class InactivityTimer {
	...
	public synchronized void onPause() {
		...
		if (registered) {
			...
			Logger.w("PowerStatusReceiver was never registered?");
		}
	}

	public synchronized void onResume() {
		if (registered) {
			Logger.w("PowerStatusReceiver was already registered?");
		}
		else {
	...
	private final class InactivityAsyncTask extends
		...
		protected Object doInBackground(Object... objects) {
			try {
				...
				Logger.i("Finishing activity due to inactivity");
				activity.finish();
			}

...
public class QRCodeUtil {
     ...
     */
	public static Bitmap createQRCode(Context context, String content, int logoResId){
		Bitmap logo = null;
		try {
			Drawable drawable = context.getResources().getDrawable(logoResId);
			logo = ((BitmapDrawable)drawable).getBitmap();
		} catch (Exception e) {
			
		}
		Bitmap b = createQRImage(content, WIDTH, HEIGHT, logo);
		return b;
	}
     ...
     */
    public static Bitmap createQRImage(String content, int widthPix, 

...
public final class CameraManager {
	...
	public synchronized void openDriver(SurfaceHolder holder)
		...
		try {
			...
			// Driver failed
			Logger.w("Camera rejected parameters. Setting only minimal safe-mode parameters");
			Logger.i("Resetting to saved camera params: "
					+ parametersFlattened);
			// Reset:
			if (parametersFlattened != null) {
				...
				try {
					...
					// Well, darn. Give up
					Logger.w("Camera rejected even safe-mode parameters! No configuration");
				}
			}
		}
	...
	public synchronized Rect getFramingRect() {
		if (framingRect == null) {
			...
			Logger.d("Calculated framing rect: " + framingRect);
		}
	...
	public synchronized Rect getFramingRectInPreview() {
		if (framingRectInPreview == null) {
			...
			Logger.d("Calculated framingRectInPreview rect: "
					+ framingRectInPreview);
			Logger.d("cameraResolution: " + cameraResolution);
			Logger.d("screenResolution: " + screenResolution);
		}
	...
	public synchronized void setManualFramingRect(int width, int height) {
		if (initialized) {
			...
			framingRect = new Rect(leftOffset, topOffset, leftOffset + width,
					topOffset + height);
			Logger.d("Calculated manual framing rect: " + framingRect);
			framingRectInPreview = null;
		}
		else {

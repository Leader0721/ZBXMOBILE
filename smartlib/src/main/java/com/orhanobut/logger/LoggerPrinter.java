...
final class LoggerPrinter implements IPrinter {
	...
	/**
	 * The minimum stack trace index, starts at this class after two native
	 * calls.
	 */
	 ...
	 * 
	 * @param tag
	 *            is the given string which will be used in Logger
	 */
	@Override
	...
	@Override
	public IPrinter t(String tag, int methodCount) {
		if (tag != null) {
			localTag.set(tag);
		}
	...
	private synchronized void log(int logType, String msg, Object... args) {
		...
		// get bytes of message with system's default charset (which is UTF-8
		// for Android)
	...
	private void logHeaderContent(int logType, String tag, int methodCount) {
		...
		for (int i = methodCount; i > 0; i--) {
			...
			builder.append("║ ")
					...
					.append(" ").append(" (")
					.append(trace[stackIndex].getFileName()).append(":")

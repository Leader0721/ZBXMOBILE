...
public class SlideDateTimePicker {
    ...
    public SlideDateTimePicker(FragmentManager fm) {
        ...
        Fragment prev = fm.findFragmentByTag(NewSlideDateTimeDialogFragment.TAG_SLIDE_DATE_TIME_DIALOG_FRAGMENT);
    ...
    public void setisHaveTime(int isHaveTime) {
    ...
    public void show() {
        ...
        NewSlideDateTimeDialogFragment dialogFragment =
                NewSlideDateTimeDialogFragment.newInstance(
                        mListener,
                        mInitialDate,
                        mMinDate,
                        mMaxDate,
        ...
        dialogFragment.show(mFragmentManager,
                NewSlideDateTimeDialogFragment.TAG_SLIDE_DATE_TIME_DIALOG_FRAGMENT);
    }
    ...
    public static class Builder {
         ...
         * @see SlideDateTimePicker#setIs24HourTime(boolean)
         */
        public Builder setIsHaveTime(int isHaveTime) {
        ...
        public SlideDateTimePicker build() {
            ...
            picker.setisHaveTime(isHaveTime);

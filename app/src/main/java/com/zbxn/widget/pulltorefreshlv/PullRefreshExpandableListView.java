 ...
 * @author ChaiHongwei
 */
public class PullRefreshExpandableListView extends SwipeRefreshLayout
        implements
        OnScrollListener {
    private static final String TAG = PullRefreshExpandableListView.class
            .getSimpleName();
    /**
     * 列表视图
     */
    ...
    private void init(Context context) {
        ...
        addView(mListView, LayoutParams.MATCH_PARENT,

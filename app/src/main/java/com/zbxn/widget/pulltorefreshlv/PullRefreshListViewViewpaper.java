 ...
 * @author ChaiHongwei
 */
public class PullRefreshListViewViewpaper extends SwipeRefreshLayout
        implements
        OnScrollListener {
    private static final String TAG = PullRefreshListViewViewpaper.class
            .getSimpleName();
    /**
     * 列表视图
     */
    ...
    public PullRefreshListViewViewpaper(Context context) {
        super(context);
        init(context);
    }

    public PullRefreshListViewViewpaper(Context context, AttributeSet attrs) {
        super(context, attrs);

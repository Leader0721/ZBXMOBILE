...
/**
 * 中文的默认实现类
 * 如果你想实现更多的语言请参考Language{@link ZSSLManager}
 *
 * The implementation class of chinese.
 * You can refer to Language{@link ZSSLManager} if you want to define more language.
 *
 * @author ZSS 2015-03-28
 */
public class CN extends ZSSLManager {
    @Override

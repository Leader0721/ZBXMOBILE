 ...
 */
public class RepeatNewTaskAdapter extends BaseAdapter {


    private Context mCxontext;
    private List<RepeatNewTaskEntity> mList;

    public RepeatNewTaskAdapter(Context mContext, List<RepeatNewTaskEntity> mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //获取到的数据显示上去
        holder.myRemind.setText(mList.get(position).getTypeName());

...
public class AppException extends Exception implements UncaughtExceptionHandler {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -9092940304344992089L;
	...
	public final static byte TYPE_AUTH = 0x09;
	 ...
	 * Toast.makeText(ctx, err, Toast.LENGTH_SHORT).show(); brea	 * TYPE_HTTP_CODE: String err =
k; case
	 ...
	 * R.string.app_run_code_error, Toast.LENGTH_SHORT) .show(); break; case
	 * TYPE_AUTH: Toast.makeText(ctx, R.string.app_auth_code_error,
	...
	private String getCrashReport(Context context, Throwable ex) {
		PackageInfo pinfo = ((MyApplication) context.getApplicationContext())
				.getPackageInfo();

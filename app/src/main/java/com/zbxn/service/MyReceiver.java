...
import com.zbxn.activity.OutLoginActivity;
        ...
        if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
            ...
            try {
                ...
                while (it.hasNext()) {
                    ...
                    } else if ("uuid".equals(myKey)) {
                        uuid = json.optString(myKey);
                    } else if ("description".equals(myKey)) {
                        description = json.optString(myKey);
                    }
                }

                if ("-1".equals(type)) {
                    String pushGuid = StringUtils.getPushGuid(context);
                    if (!StringUtils.isEmpty(pushGuid) && !pushGuid.equals(uuid)) {
                        JPushLocalNotification ln = new JPushLocalNotification();
                        ln.setBuilderId(0);
                        ln.setContent(description);
                        ln.setTitle("下线提醒");

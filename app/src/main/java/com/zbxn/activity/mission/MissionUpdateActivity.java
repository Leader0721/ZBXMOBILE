...
public class MissionUpdateActivity extends AbsToolbarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MissionDetailEntity entity = getIntent().getBundleExtra("detail").getParcelable("mission");

        mGuid = entity.getAttachmentGUID();

        ID = entity.getID() + "";
        etMissionName.setText(entity.getTaskTitle());
        tvEndTime.setText(entity.getEndTime());
        etWorkHours.setText(entity.getWorkHours() + "");
        tvChargePeople.setText(entity.getPersonLeadingName());
        etSub.setText(entity.getTaskContent());
        tvExecutorPeople.setText(entity.getPersonExecuteNames());
        currentCompanyId = entity.getCurrentCompanyId() + "";
        creatHeadUrl = entity.getPersonCreateHeadUrl();
        mTaskState = entity.getTaskState() + "";
        mDoneProgress = entity.getDoneProgress() + "";
        if (StringUtils.isEmpty(entity.getPersonExecuteNames())) {
            tvExecutorPeople.setText(" ");
        }
        tvCheckerPeople.setText(entity.getPersonCheckNames());
        choosedDiffNum = entity.getDifficultyLevel();
        if (entity.getDifficultyLevel() == 0) {
            tvDifficulty.setText("普通");
        } else if (entity.getDifficultyLevel() == 1) {
            tvDifficulty.setText("困难");
        }

        choosedLevelNum = entity.getUrgentLevel();
        ...
        chargeId = entity.getPersonLeadingId() + "";//负责人id
        checkerId = entity.getPersonCheckId() + "";//审核人id
        executersId = entity.getPersonExecuteIds();//执行人id
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.ll_charge_people:
                //负责人
//                startActivityForResult(new Intent(this, SelectOnePeopleActivity.class), Flag_Callback_Charge);
...
//                startActivityForResult(new Intent(this, ContactsPicker.class), Flag_Callback_Copy);
    ...
    public void addNewMission(final boolean isChild) {
        ...
        mMap.put("EndTime", StringUtils.getEditText(tvEndTime));
        //工作量
        ...
        //任务状态
        mMap.put("TaskState", mTaskState);
        //任务完成进度
        mMap.put("DoneProgress", mDoneProgress);
        //负责人姓名
        mMap.put("PersonLeadingName", StringUtils.getEditText(tvChargePeople));
        //任务内容描述
        /*if (!IsEmptyUtil.isEmpty(etSub, "请输入任务内容描述")) {
            return;
        }*/
        mMap.put("TaskContent", etSub.getText().toString());
        ...
        public void onCustomListener(int obj0, Object obj1, int position) {
            switch (obj0) {
                ...
                case 3://显示大图
                    ...
                    Intent intent = new Intent(MissionUpdateActivity.this, PhotoDetaiActivity.class);
    ...
    public void updateMission(Context context, Map<String, String> map) {
        ...
        new BaseAsyncTask(this, false, 0, netServer + "UpdateTask", new BaseAsyncTaskInterface() {
            @Override
            public void dataSubmit(int funId) {

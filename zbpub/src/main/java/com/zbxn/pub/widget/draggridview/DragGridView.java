...
public class DragGridView extends GridView {
    ...
    private IDragGridAdapter mDragAdapter;
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        if (adapter instanceof IDragGridAdapter) {
            mDragAdapter = (IDragGridAdapter) adapter;
        } else {
    ...
    private void onSwapItem(int moveX, int moveY) {
        ...
        if (tempPosition != mDragPosition && tempPosition != AdapterView.INVALID_POSITION && mAnimationEnd) {
            mDragAdapter.reorderItems(mDragPosition, tempPosition);//交换拖动的两个item的方法
     ...
     */
    private void setParentTouchEnable(boolean disallowIntercept) {
        if (parentView != null)
            parentView.requestDisallowInterceptTouchEvent(disallowIntercept);
    }

    private IDragListener dragListener = null;
     ...
     * @param listener
     */
    public void setOnDragListener(IDragListener listener) {

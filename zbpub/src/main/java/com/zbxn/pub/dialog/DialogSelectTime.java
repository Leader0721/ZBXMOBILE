 ...
 * 日期选择器
 */
public class DialogSelectTime extends Dialog implements OnClickListener {
...
//    private TextView m_title;
    ...
    public DialogSelectTime(Activity context, DialogAlertListener listener, Object param) {
...
//        m_title.setText("选择时间");
    ...
    private void initView() {
        ...
        wheelMain = new WheelMain(timePicker,true);
